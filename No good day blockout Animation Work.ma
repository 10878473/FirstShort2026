...
//Last modified: Wed, Jan 28, 2026 08:00:12 PM
//Codeset: 1252
...
fileInfo "UUID" "3E0A986B-494A-837B-10B5-28911F9C0521";
createNode transform -s -n "persp";
	rename -uid "F9BEFF7E-4F63-9C65-888C-FCB00E630962";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.2774447762210572 2.5584176592470369 20.02483539378602 ;
	setAttr ".r" -type "double3" -15.93835272651634 -738.2000000002962 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 4.1838953441155979;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0E440C4F-45A0-2916-628A-AAA755B15203";
	setAttr -s 58 ".lnk";
	setAttr -s 58 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "49B503EA-4889-60E4-F2E0-AD9F266C337D";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 3 0 1 2 ;
	setAttr -s 3 ".bspr";
	setAttr -s 3 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B60EEFD5-4366-C92F-8F23-90B34EE6EE62";
createNode displayLayerManager -n "layerManager";
	rename -uid "2F7B5DD9-460A-A128-2677-439E05E2F139";
	setAttr ".cdl" 1;
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "81FDBB41-4E3D-948F-37BF-719D84734FAB";
...
createNode reference -n "Waitress_rig_v01RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"Waitress_rig_v01RN" 4
		2 "|Waitress_rig_v01:Global_ctrl_offs|Waitress_rig_v01:Global_ctrl" "translate" 
		" -type \"double3\" -0.61574315110745537 0 16.13916993298825275"
